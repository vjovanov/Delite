...
trait CustomerOps extends DSLType with Variables with OverloadHack { this: OptiQL =>
...
trait CustomerOpsExp extends CustomerOps with FieldAccessOpsExp with EffectExp with BaseFatExp { this: OptiQLExp =>
...
trait ScalaGenCustomerOps extends ScalaGenFat {
  val IR: ApplicationOpsExp with OptiQLExp
  import IR._
...
trait LineItemOps extends DSLType with Variables with OverloadHack { this: OptiQL =>
...
trait LineItemOpsExp extends LineItemOps with FieldAccessOpsExp with EffectExp with BaseFatExp { this: OptiQLExp =>
...
trait NationOps extends DSLType with Variables with OverloadHack { this: OptiQL =>
...
trait NationOpsExp extends NationOps with FieldAccessOpsExp with EffectExp with BaseFatExp { this: OptiQLExp =>
...
trait OrderOps extends DSLType with Variables with OverloadHack { this: OptiQL =>
...
trait OrderOpsExp extends OrderOps with FieldAccessOpsExp with EffectExp with BaseFatExp { this: OptiQLExp =>
...
trait PartOps extends DSLType with Variables with OverloadHack { this: OptiQL =>
...
trait PartOpsExp extends PartOps with FieldAccessOpsExp with EffectExp with BaseFatExp { this: OptiQLExp =>
...
trait PartSupplierOps extends DSLType with Variables with OverloadHack { this: OptiQL =>
...
trait PartSupplierOpsExp extends PartSupplierOps with FieldAccessOpsExp with EffectExp with BaseFatExp { this: OptiQLExp =>
...
trait RegionOps extends DSLType with Variables with OverloadHack { this: OptiQL =>
...
trait RegionOpsExp extends RegionOps with FieldAccessOpsExp with EffectExp with BaseFatExp { this: OptiQLExp =>
...
trait SupplierOps extends DSLType with Variables with OverloadHack { this: OptiQL =>
...
trait SupplierOpsExp extends SupplierOps with FieldAccessOpsExp with EffectExp with BaseFatExp { this: OptiQLExp =>
...
trait ApplicationOps extends CustomerOps with LineItemOps with NationOps with OrderOps with PartOps with PartSupplierOps with RegionOps with SupplierOps { this: OptiQL => }
trait ApplicationOpsExp extends FieldAccessOpsExp with CustomerOpsExp with LineItemOpsExp with NationOpsExp with OrderOpsExp with PartOpsExp with PartSupplierOpsExp with RegionOpsExp with SupplierOpsExp { this: OptiQLExp => }
